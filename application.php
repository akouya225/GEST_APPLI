        ...
        <div class="table-container">
            <table class="table-list table-striped table-bordered table-sm text-center">
                ...
                <tbody>
                    ...
                    // Récupérer les données avec les libellés des tables associées
                    $sql = "SELECT 
                                app.id, 
                                app.nom, 
                                app.description, 
                                app.statut, 
                                app.version, 
                                arch.libelle AS architecture, 
                                mode.libelle AS mode_deploiement, 
                                niveau.libelle AS niveau_couche
                    ...
                    foreach ($applications as $application) {
                        echo "<tr>
                            ...
                            <td>" . htmlspecialchars($application['architecture']) . "</td>
                            <td>" . htmlspecialchars($application['mode_deploiement']) . "</td>
                            <td>" . htmlspecialchars($application['niveau_couche']) . "</td>
                            <td class='d-flex'>
