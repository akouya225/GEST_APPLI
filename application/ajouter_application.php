...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($stmt->execute()) {
        ...
        header("Location: ajouter_application.php?success=true");
        exit();
    } else {
        ...
        <form action="ajouterapp.php" method="POST">
            ...
            <div class="form-group">
                ...
                <select name="idarch" id="idarch" class="form-control" required>
                    <option value="1">Monolytique</option>
                    <option value="2">Microservice</option>
                </select>
            </div>
            <div class="form-group">
                ...
                <select name="idmopl" id="idmopl" class="form-control" required>
                    ...
                    <option value="2">Containe</option>
            ...
            <div class="form-group">
                ...
                <select name="idnicou" id="idnicou" class="form-control" required>
                    ...
                    <option value="2">Full-Start</option>
            ...
            <button type="button" class="btn btn-danger" onclick="location.href='application.php'">retour à la liste</button>
          </form>
    </div>
